...
- (void)setup {
    ...
    self.backgroundColor = [UIColor whiteColor];//IS_IPAD ? [UIColor clearColor] : [UIColor colorWithRed:0.225 green:0.225 blue:0.225 alpha:1.000];
	...
	// brightness slider
	KZColorPickerBrightnessSlider *slider = [[KZColorPickerBrightnessSlider alloc] initWithFrame:CGRectMake(330,//24,
																											277,
																											272,
																											38)];
    ...
    // alpha slider
    KZColorPickerAlphaSlider *alpha = [[KZColorPickerAlphaSlider alloc] initWithFrame:CGRectMake(330,//24,
                                                                                                 321,
                                                                                                 272,
                                                                                                 38)];
    ...
    KZColorCompareView *colorView = [[KZColorCompareView alloc] initWithFrame:CGRectMake(330,//10,
                                                                                         10, 44, 44)];
...
- (void)brightnessChanged:(KZColorPickerBrightnessSlider *)slider {
    NSLog(@"slider valud:%f", slider.value);
...
- (void)fixLocations {
    ...
    if(self.bounds.size.width < self.bounds.size.height)
    {
        ...
        {
            swatch.frame = CGRectMake(330,//sx + swatchCellWidth * 0.5 - 18.0,
                                      sy, 36.0, 36.0);
            sx += swatchCellWidth;
        }
        
        self.brightnessSlider.frame = CGRectMake(330,//24,
                                                 277,
                                                 272,
                                                 38);
        
        self.alphaSlider.frame = CGRectMake(330,//24,
                                            321,
                                            272,
                                            38);
    }
    else
    {
        ...
        self.brightnessSlider.frame = CGRectMake(330,//300,
                                                 self.bounds.size.height * 0.5 - 38 - 50,
                                                 165,
                                                 38);
        
        self.alphaSlider.frame = CGRectMake(330,//300,
